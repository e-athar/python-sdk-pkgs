...
class ApiClient(object):
    ...
    def __getattr(self, name):
        if hasattr(prism_client.Ntnx, name.split('.')[-1]):
            return getattr(prism_client.Ntnx, name.split('.')[-1])
        else:
            return getattr(prism_client.Ntnx, name)
