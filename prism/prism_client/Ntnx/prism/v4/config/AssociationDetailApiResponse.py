...
from prism_client.Ntnx.OneOfprism.v4.config.AssociationDetailApiResponsedata import AssociationDetailApiResponsedata  # noqa: F401,E501
...
class AssociationDetailApiResponse(object):
    """AssociationDetailApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a1.config.AssociationDetailApiResponse'
    ...
    @property
    def data(self):
        """`{ list[prism.v4.config.AssociationDetail] | prism.v4.error.ErrorResponse | list[prism.v4.config.AssociationDetailProjection] }`
