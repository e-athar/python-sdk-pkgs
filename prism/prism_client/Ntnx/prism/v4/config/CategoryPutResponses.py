...
from prism_client.Ntnx.OneOfprism.v4.config.CategoryPutResponsesdata import CategoryPutResponsesdata  # noqa: F401,E501
...
class CategoryPutResponses(object):
    """CategoryPutResponses - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.config.CategoryPutResponsesdata',
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a1.config.CategoryPutResponses'
    ...
    @property
    def data(self):
        """`{ prism.v4.config.Category | prism.v4.error.ErrorResponse }`
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CategoryPutResponses, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryPutResponses):
            return False
