...
from prism_client.Ntnx.OneOfprism.v4.config.CategoryGetResponsesdata import CategoryGetResponsesdata  # noqa: F401,E501
...
class CategoryGetResponses(object):
    """CategoryGetResponses - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.config.CategoryGetResponsesdata',
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a1.config.CategoryGetResponses'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CategoryGetResponses, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryGetResponses):
            return False
