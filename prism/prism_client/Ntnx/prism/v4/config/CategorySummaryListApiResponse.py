...
import six
import prism_client.Ntnx
from prism_client.Ntnx.OneOfprism.v4.config.CategorySummaryListApiResponsedata import CategorySummaryListApiResponsedata  # noqa: F401,E501
from prism_client.Ntnx.common.v1.response.ApiResponseMetadata import ApiResponseMetadata  # noqa: F401,E501
...
class CategorySummaryListApiResponse(object):
    """CategorySummaryListApiResponse - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    swagger_types = {
        ...
        'data': 'OneOfprism.v4.config.CategorySummaryListApiResponsedata',
    ...
    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a1.config.CategorySummaryListApiResponse'
    ...
    @property
    def data(self):
        """`{ list[prism.v4.config.CategorySummary] | prism.v4.error.ErrorResponse | list[prism.v4.config.CategorySummaryProjection] }`
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if attr_type.startswith('OneOf'):
                type = getattr(prism_client.Ntnx, attr_type.split('.')[-1])
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CategorySummaryListApiResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategorySummaryListApiResponse):
            return False
