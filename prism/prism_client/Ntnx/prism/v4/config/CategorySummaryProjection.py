...
class CategorySummaryProjection(CategorySummary):
    """CategorySummaryProjection - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def __init__(self, category_association_summary_projection=None, category_summary_projection=None, fq_name=None, name=None, parent_ext_id=None, user_specified_name=None, type=None, description=None, associations=None, child_categories=None, ext_id=None, links=None, tenant_id=None, *args, **kwargs):  # noqa: E501
        """CategorySummaryProjection - a model defined in Swagger
    ...
    def _initialize_object_type(self):
        return 'prism.v4.config.CategorySummaryProjection'

    def _initialize_fq_object_type(self):
        return 'prism.v4.r0.a1.config.CategorySummaryProjection'
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CategorySummaryProjection, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategorySummaryProjection):
            return False
