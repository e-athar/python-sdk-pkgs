...
class CategoryGetResponsesdata(object):
    """CategoryGetResponsesdata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.CategoryGetResponsesdata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CategoryGetResponsesdata.discriminator_value_class_map.values():
            return list(CategoryGetResponsesdata.discriminator_value_class_map.keys())[list(CategoryGetResponsesdata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CategoryGetResponsesdata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategoryGetResponsesdata):
            return False
