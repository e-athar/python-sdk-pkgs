...
class CategorySummaryListApiResponsedata(object):
    """CategorySummaryListApiResponsedata - a model defined in Swagger"""
    """
    IGNORE:
    Attributes:
    ...
    discriminator_value_class_map = {
        'EMPTY_LIST': 'list[str]',
        'List<prism.v4.config.CategorySummary>': 'list[prism.v4.config.CategorySummary]',
        'prism.v4.error.ErrorResponse': 'prism.v4.error.ErrorResponse',
        'List<prism.v4.config.CategorySummaryProjection>': 'list[prism.v4.config.CategorySummaryProjection]'
    }
    ...
    def _initialize_object_type(self):
        return 'OneOfprism.v4.config.CategorySummaryListApiResponsedata'
    ...
    def get_discriminator_from_object(value):
        ...
        if disc in CategorySummaryListApiResponsedata.discriminator_value_class_map.values():
            return list(CategorySummaryListApiResponsedata.discriminator_value_class_map.keys())[list(CategorySummaryListApiResponsedata.discriminator_value_class_map.values()).index(disc)]
        return None
    ...
    def to_dict(self):
        ...
        for attr, attr_type in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CategorySummaryListApiResponsedata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CategorySummaryListApiResponsedata):
            return False
