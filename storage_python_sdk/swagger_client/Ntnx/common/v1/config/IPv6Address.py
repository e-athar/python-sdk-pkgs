...
class IPv6Address(object):
    ...
    @property
    def value(self):
        """Gets the value of this IPv6Address.  # noqa: E501


        :return: The value of this IPv6Address.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this IPv6Address.


        :param value: The value of this IPv6Address.  # noqa: E501
        :type: str
        """
        if value is not None and not re.search(r'^(?:(?:(?:[A-Fa-f0-9]{1,4}:){6}|(?=(?:[A-Fa-f0-9]{0,4}:){0,6}(?:[0-9]{1,3}\\.){3}[0-9]{1,3}$)(([0-9a-fA-F]{1,4}:){0,5}|:)((:[0-9a-fA-F]{1,4}){1,5}:|:)|::(?:[A-Fa-f0-9]{1,4}:){5})(?:(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9]?[0-9])\\.){3}(?:25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[1-9]?[0-9])|(?:[A-Fa-f0-9]{1,4}:){7}[A-Fa-f0-9]{1,4}|(?=(?:[A-Fa-f0-9]{0,4}:){0,7}[A-Fa-f0-9]{0,4}$)(([0-9a-fA-F]{1,4}:){1,7}|:)((:[0-9a-fA-F]{1,4}){1,7}|:)|(?:[A-Fa-f0-9]{1,4}:){7}:|:(:[A-Fa-f0-9]{1,4}){7})$', value):  # noqa: E501
    ...
    def prefix_length(self):
        """Gets the prefix_length of this IPv6Address.  # noqa: E501

        Prefix length of the network to which this host IPv6 address belongs.   # noqa: E501

        :return: The prefix_length of this IPv6Address.  # noqa: E501
        :rtype: int
        """
    ...
    def prefix_length(self, prefix_length):
        """Sets the prefix_length of this IPv6Address.

        Prefix length of the network to which this host IPv6 address belongs.   # noqa: E501

        :param prefix_length: The prefix_length of this IPv6Address.  # noqa: E501
        :type: int
        """
    ...
    @property
    def _reserved(self):
        """Gets the _reserved of this IPv6Address.  # noqa: E501


        :return: The _reserved of this IPv6Address.  # noqa: E501
    ...
    def _object_type(self):
        """Gets the _object_type of this IPv6Address.  # noqa: E501


        :return: The _object_type of this IPv6Address.  # noqa: E501
        :rtype: str
        """
        return self.__object_type
    ...
    def _unknown_fields(self):
        """Gets the _unknown_fields of this IPv6Address.  # noqa: E501


        :return: The _unknown_fields of this IPv6Address.  # noqa: E501
        :rtype: dict(str, object)
        """
        return self.__unknown_fields
